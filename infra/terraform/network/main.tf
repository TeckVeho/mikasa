...
locals {
  network_name_effective = var.network_name != "" ? var.network_name : "logivoice-vpc-${var.env_suffix}"
  subnet_connector_name  = "logivoice-connector-${var.env_suffix}"
}
...
resource "google_compute_global_address" "private_service_range" {
  name          = "logivoice-psa-${var.env_suffix}"
  purpose       = "VPC_PEERING"
